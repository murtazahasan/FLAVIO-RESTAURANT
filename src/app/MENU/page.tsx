...
function Page() {
  ...
  <button
    style={{ backgroundColor: activeSection === "BURGERS" ? "#34D399" : "" }}
  ...
  <button
    style={{ backgroundColor: activeSection === "PIZZA" ? "#34D399" : "" }}
    className="bg-white font-bold text-center p-2 m-1 rounded-2xl"
  ...
  <button
    style={{ backgroundColor: activeSection === "ROLLS" ? "#34D399" : "" }}
    className="bg-white font-bold text-center p-2 m-1 rounded-2xl"
  ...
  <button
    style={{ backgroundColor: activeSection === "BEVERAGES" ? "#34D399" : "" }}
    className="bg-white font-bold text-center p-2 m-1 rounded-2xl"
